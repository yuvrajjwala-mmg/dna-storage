...
const TheShift = () => {
  return (
    <section className='bg-[url("/images/background/the-shift.png")] bg-cover bg-center bg-no-repeat flex flex-col justify-between items-stretch gap-24 min-h-[700px] h-screen py-32'>
